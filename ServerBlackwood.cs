...
namespace ServerBlackwood
{
    ...
    public class ServerBlackwood
    {
            ...
            if (!_exeID.ContainsKey(executionMsg.ExecutionID.Value))
            {
                ...
                foreach (KeyValuePair<long, int> ordID in _longint)
                    if (ordID.Value == executionMsg.SmartID.Value)
                    {
                        ...
                        t.Account = _acct; // executionMsg.UserID.ToString();
                        t.id = ordID.Key;
        ...
        private FEED_ID getVenueFromBW(Order o)
        {
            ...
            {
                case "ARCA":
                    bwVenue = /*BWVenue*/FEED_ID.ARCA; //APICHANGE
                    break;
                case "BATS":
                    bwVenue = /*BWVenue*/FEED_ID.BATS; //APICHANGE
                    break;
                case "INET":
                    bwVenue = /*BWVenue*/FEED_ID.INET; //APICHANGE
                    break;
                case "NSDQ":
                    bwVenue = /*BWVenue*/FEED_ID.NASDAQ; //APICHANGE
                    break;
                case "NYSE":
                    bwVenue = /*BWVenue*/FEED_ID.BLZ; //APICHANGE
                    break;
                case "NITE":
                    bwVenue = /*BWVenue*/FEED_ID.NITE; //APICHANGE
                    break;
                case "EDGA":
                    bwVenue = /*BWVenue*/FEED_ID.EDGA; //APICHANGE
                    break;
                case "EDGX":
                    bwVenue = /*BWVenue*/FEED_ID.EDGX; //APICHANGE
                    break;
                case "CSFB":
                    bwVenue = /*BWVenue*/FEED_ID.CSFB; //APICHANGE
                    break;
                case "Toronto":
                    bwVenue = /*BWVenue*/FEED_ID.TSE; //APICHANGE
                    break;
                case "Vancouver": // apparently this is Toronto as well?
                    bwVenue = /*BWVenue*/FEED_ID.VSE; //APICHANGE
                    break;
                case "Citibank":
                    bwVenue = /*BWVenue*/FEED_ID.ATDPING; //APICHANGE
                    break;
                case "Goldman":
                    bwVenue = /*BWVenue*/FEED_ID.GSCO; //APICHANGE
                    break;
                case "MAXM":
                    bwVenue = /*BWVenue*/FEED_ID.MAXM; //APICHANGE
                    break;
                case "CME":
                    bwVenue = /*BWVenue*/FEED_ID.CME; //APICHANGE
                    break;
                default:
                    bwVenue = /*BWVenue*/FEED_ID.NONE; //APICHANGE
                    break;
            }
            return bwVenue;
        }
